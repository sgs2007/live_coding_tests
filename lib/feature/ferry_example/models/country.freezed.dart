...
abstract class $CountryCopyWith<$Res> {
  ...
  @useResult
  $Res call({String name, String code, String native, String? currency});
}
...
class _$_Country with DiagnosticableTreeMixin implements _Country {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Country(name: $name, code: $code, native: $native, currency: $currency)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, name, code, native, currency);
...
abstract class _Country implements Country {
  const factory _Country(
      ...
      required final String? currency}) = _$_Country;
